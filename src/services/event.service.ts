...
export interface ClinicalEventPayload {
  ...
  /**
   * Optional: caller may pre-specify the UUID so sub-events (e.g. AcuityGovernanceEvent)
   * can reference the parent event ID before the DB write occurs.
   * If omitted, a fresh UUID is generated by the service.
   */
  event_id?: string;
